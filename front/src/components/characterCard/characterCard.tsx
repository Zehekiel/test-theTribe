...
function CharacterCard (props: {oneCharacter: Characters}){
  ...
  const { name, skillPoint, health, attack, defense, magik, level, lastFight, _id} = props.oneCharacter
    ...
    <Linker to={`/character/${_id}`}>
      <article className='characterCard'>
        <section className='characterIdentity' id='identity' >
          ...
          <p className='characterStat'>LVL: <strong>{level}</strong> </p>
        ...
        <section className='characterIdentity'>
          <p className='characterStat'>PV:  <strong>{health}</strong></p>
          <p className='characterStat'>PM:  <strong>{magik}</strong></p>
        </section>

        <section className='characterIdentity'>
          <p className='characterStat'>ATT: <strong>{attack}</strong></p>
          <p className='characterStat'>DEF: <strong>{defense}</strong></p>
        </section>
