...
function NewCharacter() {
  ...
  return (
    <main className='newCharacterContainer'>
      ...
      <p>Vous avez <strong>{newCharacter.skillPoint} {newCharacter.skillPoint ===0 ? 'point' : 'points'} de compétence (PC)</strong>  à répartir entre les différentes statistiques </p>
      <input
        type='text'
        placeholder='Nom du personnage'
        value={newCharacter.name}
        onChange={(e)=> setNewCharacter(old =>( {...old, 'name': e.target.value})) }
        className='logInput'
      />
      ...
      <div className='stat'>
        ...
        />
        <p className='statCost'>{skillPointCost(newCharacter.attack, true)} PC</p>
      ...
      <div className='stat'>
        ...
        />
        <p className='statCost'>{skillPointCost(newCharacter.defense, true)} PC</p>
      </div>
      ...
      <div className='stat'>
        ...
        />
        <p className='statCost'>{skillPointCost(newCharacter.magik, true)} PC</p>
      </div>

      <ErrorText text={errorMessage}/>
      {showSaveButton && <button className='saveButton' onClick={()=> saveNewCharacter()}>Sauvegarder</button> }
